          ...
          <CardContent className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                Güncel toplumsal eğilimleri ve kamu gündemini yansıtmak amacıyla sosyal medya verileri üç ana platformdan toplanmaktadır: yerli bir sosyal medya ağı olan Next Sosyal, küresel erişime sahip Instagram ve X (eski adıyla Twitter). Bu platformlar, kullanıcıların bakanlıklar ve çevresel konular gibi belirli başlıklara yönelik görüş ve duyarlılıklarını ifade ettikleri geniş bir veri havuzu sunmaktadır.
